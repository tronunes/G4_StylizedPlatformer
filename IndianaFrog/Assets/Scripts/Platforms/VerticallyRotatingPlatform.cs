...
public class VerticallyRotatingPlatform : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float startYaw = pivotOriginalRotation.eulerAngles.x;
        float endYaw = pivotOriginalRotation.eulerAngles.x + 360f;
        ...
        rotationPivot.rotation = Quaternion.Euler(
            targetYaw,
            pivotOriginalRotation.eulerAngles.y,
